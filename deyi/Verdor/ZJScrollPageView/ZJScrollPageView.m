...
- (void)updateChildrenFrame
{
    CGRect frame = self.bounds;
    frame.origin.y += self.segmentStyle.segmentHeight;
    frame.size.height -= self.segmentStyle.segmentHeight;
    self.contentView.frame = frame;
    //self.contentView.collectionView.frame = self.contentView.bounds;
}
